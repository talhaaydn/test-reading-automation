...
@section('content')
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Dönem Listesi</h3>

            <a href="{{ route('term.create') }}" class="btn btn-add">
                ...
                <tbody>
                    ...
                    @foreach ($terms as $index => $item)
                        <tr>
                            ...
                            <td>{{ $item->term }}</td>
                            <td>
                                <a href="{{ route('term.edit', $item->id) }}" class="btn btn-action btn-edit" data-toggle="tooltip" data-placement="top" title="Düzenle">
